...
function saveOrderShippingDetails($idCart, $idCustomer, $soParams) {
    ...
    if ($numRows == 0) {
        $sql = 'INSERT INTO ' . _DB_PREFIX_ . 'socolissimo_delivery_info
										...
										`pradress1`, `pradress2`, `pradress3`, `pradress4`, `przipcode`, `prtown`, `cecountry`, `cephonenumber`, `ceemail` , `cecompanyname`, `cedeliveryinformation`, `cedoorcode1`, `cedoorcode2`)
        ...
        if (!in_array($soParams['DELIVERYMODE'], array('DOM', 'RDV'))) {
            ...
            (isset($soParams['PRTOWN']) ? $values['prtown'] = pSQL($soParams['CETOWN']) : '');
